...
--15. 생산 업체별 재료 가격 변경 기록 테이블
CREATE TABLE SOURCE_PRICE_HISTORY
(
    SOURCE_PRICE_HISTORY_ID    VARCHAR(50) PRIMARY KEY,  -- 가격 이력 PK
    SOURCE_PRICE_ID     VARCHAR(50),              -- SOURCE_PRICE 테이블 FK
    OLD_PRICE           INT,                      -- 이전 가격
    NEW_PRICE           INT,                      -- 새로운 가격
    CHANGE_DATE         DATETIME DEFAULT CURRENT_TIMESTAMP, -- 가격 변경 일자
