...
VALUES
    -- 1. 비빔밥에 대한 발주
    (UUID(), (SELECT SOURCE_PRICE_ID FROM SOURCE_PRICE WHERE SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '쌀') ORDER BY PRICE ASC LIMIT 1), 100, '2024-08-15 00:00:00', (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리전' LIMIT 1)),
