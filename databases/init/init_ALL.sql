...
VALUES
    -- 1. 비빔밥에 대한 발주
    (UUID(), (SELECT KIT_SOURCE_ID
              FROM KIT_SOURCE
              WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '비빔밥')
                AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '쌀')), 100, '2024-08-15 00:00:00',
     (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리전')),
    (UUID(), (SELECT KIT_SOURCE_ID
              FROM KIT_SOURCE
              WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '비빔밥')
                AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '김치')), 100, '2024-08-15 00:00:00',
     (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리전')),
    (UUID(), (SELECT KIT_SOURCE_ID
              FROM KIT_SOURCE
              WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '비빔밥')
                AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '된장')), 100, '2024-08-15 00:00:00',
     (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리중')),
    -- 2. 된장찌개에 대한 발주
    (UUID(), (SELECT KIT_SOURCE_ID
              FROM KIT_SOURCE
              WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '된장찌개')
                AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '된장')), 200, '2024-08-16 00:00:00',
     (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리중')),
    (UUID(), (SELECT KIT_SOURCE_ID
              FROM KIT_SOURCE
              WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '된장찌개')
                AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '두부')), 200, '2024-08-16 00:00:00',
     (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리완료')),
    (UUID(), (SELECT KIT_SOURCE_ID
              FROM KIT_SOURCE
              WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '된장찌개')
                AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '소고기')), 200, '2024-08-16 00:00:00',
     (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리완료')),
    -- 3. 김치찌개에 대한 발주
    (UUID(), (SELECT KIT_SOURCE_ID
              FROM KIT_SOURCE
              WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '김치찌개')
                AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '김치')), 100, '2024-08-17 00:00:00',
     (SELECT STATUS_ID FROM STATUS WHERE STATUS = '취소')),
    (UUID(), (SELECT KIT_SOURCE_ID
              FROM KIT_SOURCE
              WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '김치찌개')
                AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '두부')), 100, '2024-08-17 00:00:00',
     (SELECT STATUS_ID FROM STATUS WHERE STATUS = '취소')),
    (UUID(), (SELECT KIT_SOURCE_ID
              FROM KIT_SOURCE
              WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '김치찌개')
                AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '소고기')), 100, '2024-08-17 00:00:00',
     (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리전'));
...
VALUES
    -- 1. 비빔밥 발주 로그 삽입
    (UUID(), (SELECT PRODUCT_ORDER_ID
              FROM PRODUCT_ORDER
              WHERE KIT_SOURCE_ID = (SELECT KIT_SOURCE_ID
                                     FROM KIT_SOURCE
                                     WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '비빔밥')
                                       AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '쌀'))
                AND QUANTITY = 100
    ...
    (UUID(), (SELECT PRODUCT_ORDER_ID
              ...
              WHERE KIT_SOURCE_ID = (SELECT KIT_SOURCE_ID
                                     FROM KIT_SOURCE
                                     WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '비빔밥')
                                       AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '김치'))
                AND QUANTITY = 100
                AND PRODUCT_ORDER_DATE = '2024-08-15 00:00:00'), (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리전'),
     '2024-08-15 00:00:00'),
    (UUID(), (SELECT PRODUCT_ORDER_ID
              ...
              WHERE KIT_SOURCE_ID = (SELECT KIT_SOURCE_ID
                                     FROM KIT_SOURCE
                                     WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '비빔밥')
                                       AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '된장'))
                AND QUANTITY = 100
    ...
    (UUID(), (SELECT PRODUCT_ORDER_ID
              ...
              WHERE KIT_SOURCE_ID = (SELECT KIT_SOURCE_ID
                                     ...
                                     WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '된장찌개')
                                       AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '된장'))
                AND QUANTITY = 200
                AND PRODUCT_ORDER_DATE = '2024-08-16 00:00:00'), (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리중'),
     '2024-08-16 00:00:00'),
    (UUID(), (SELECT PRODUCT_ORDER_ID
              FROM PRODUCT_ORDER
              WHERE KIT_SOURCE_ID = (SELECT KIT_SOURCE_ID
                                     FROM KIT_SOURCE
                                     WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '된장찌개')
                                       AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '두부'))
                AND QUANTITY = 200
    ...
    (UUID(), (SELECT PRODUCT_ORDER_ID
              ...
              WHERE KIT_SOURCE_ID = (SELECT KIT_SOURCE_ID
                                     FROM KIT_SOURCE
                                     WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '된장찌개')
                                       AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '소고기'))
                AND QUANTITY = 200
                AND PRODUCT_ORDER_DATE = '2024-08-16 00:00:00'), (SELECT STATUS_ID FROM STATUS WHERE STATUS = '처리완료'),
     '2024-08-16 00:00:00'),
    -- 3. 김치찌개 발주 로그 삽입
    (UUID(), (SELECT PRODUCT_ORDER_ID
              ...
              WHERE KIT_SOURCE_ID = (SELECT KIT_SOURCE_ID
                                     ...
                                     WHERE MEALKIT_ID = (SELECT MEALKIT_ID FROM MEALKIT WHERE NAME = '김치찌개')
                                       AND SOURCE_ID = (SELECT SOURCE_ID FROM SOURCE WHERE NAME = '김치'))
                AND QUANTITY = 100
                AND PRODUCT_ORDER_DATE = '2024-08-17 00:00:00'), (SELECT STATUS_ID FROM STATUS WHERE STATUS = '취소'),
     '2024-08-17 00:00:00'),
    (UUID(), (SELECT PRODUCT_ORDER_ID
              FROM PRODUCT_ORDER
              WHERE KIT_SOURCE_ID = (SELECT KIT_SOURCE_ID
