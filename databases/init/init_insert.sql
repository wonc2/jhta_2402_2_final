...
INSERT INTO PRODUCT_ORDER (PRODUCT_ORDER_ID, KIT_SOURCE_PRICE_ID, QUANTITY, STATUS_ID)
VALUES
    (
        UUID(),
        (SELECT ksr.KIT_SOURCE_PRICE_ID
         FROM KIT_SOURCE_PRICE ksr
                  JOIN MEALKIT mk ON mk.MEALKIT_ID = ksr.MEALKIT_ID
...
VALUES (UUID(), (SELECT PRODUCT_ORDER_ID FROM PRODUCT_ORDER WHERE QUANTITY = 10), 1),
       (UUID(), (SELECT PRODUCT_ORDER_ID FROM PRODUCT_ORDER WHERE QUANTITY = 5), 2),
       (UUID(), (SELECT PRODUCT_ORDER_ID FROM PRODUCT_ORDER WHERE QUANTITY = 7), 3);

INSERT INTO KIT_ORDER (KIT_ORDER_ID, KIT_COMPANY_ID, MEALKIT_ID, QUANTITY, STATUS_ID)
...
VALUES (UUID(), (SELECT KIT_ORDER_ID FROM KIT_ORDER WHERE QUANTITY = 20), 1),
       (UUID(), (SELECT KIT_ORDER_ID FROM KIT_ORDER WHERE QUANTITY = 15), 1),
       (UUID(), (SELECT KIT_ORDER_ID FROM KIT_ORDER WHERE QUANTITY = 10), 2);
