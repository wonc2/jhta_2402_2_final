...
-- DROP FROM ACCOUNT
ALTER TABLE IF EXISTS `ACCOUNT` DROP FOREIGN KEY `FK_ROLE_TO_ACCOUNT_1`;
ALTER TABLE IF EXISTS `ACCOUNT` DROP FOREIGN KEY `FK_USER_TO_ACCOUNT_1`;
...
CREATE TABLE `ACCOUNT` (
                           `account_uid`	VARCHAR(50)	NOT NULL,
...
CREATE TABLE `DISTRIBUTION_LOG` (
                                    ...
                                    `detination_type`	VARCHAR(50)	NOT NULL,
...
ALTER TABLE `WAREHOUSE_STATUS` ADD CONSTRAINT `PK_WAREHOUSE_STATUS` PRIMARY KEY (
                                                                                 `warehouse_status_uid`
    );

ALTER TABLE `TRANSPORT` ADD CONSTRAINT `PK_TRANSPORT` PRIMARY KEY (
                                                                   `transport_uid`
    );
...
ALTER TABLE `SUPPLIER_STATUS` ADD CONSTRAINT `PK_SUPPLIER_STATUS` PRIMARY KEY (
                                                                               `supplier_status_uid`
    );

ALTER TABLE `STORE_STATUS` ADD CONSTRAINT `PK_STORE_STATUS` PRIMARY KEY (
                                                                         `store_status_uid`
    );
...
ALTER TABLE `DISTRIBUTION_LOG` ADD CONSTRAINT `PK_DISTRIBUTION_LOG` PRIMARY KEY (
...
ALTER TABLE `ACCOUNT` ADD CONSTRAINT `FK_ROLE_TO_ACCOUNT_1` FOREIGN KEY (
                                                                         `role_uid`
    )
    REFERENCES `ROLE` (
                       `role_uid`
...
ALTER TABLE `ACCOUNT` ADD CONSTRAINT `FK_USER_TO_ACCOUNT_1` FOREIGN KEY (
                                                                         `user_uid`
    )
    REFERENCES `USER` (
                       `user_uid`
...
ALTER TABLE `WAREHOUSE` ADD CONSTRAINT `FK_ROLE_TO_WAREHOUSE_1` FOREIGN KEY (
                                                                             `role_uid`
    )
    REFERENCES `ROLE` (
                       `role_uid`
...
ALTER TABLE `WAREHOUSE_STATUS` ADD CONSTRAINT `FK_WAREHOUSE_TO_WAREHOUSE_STATUS_1` FOREIGN KEY (
                                                                                                `warehouse_uid`
    )
...
ALTER TABLE `WAREHOUSE_STATUS` ADD CONSTRAINT `FK_PRODUCT_TO_WAREHOUSE_STATUS_1` FOREIGN KEY (
                                                                                              `product_uid`
    )
    REFERENCES `PRODUCT` (
                          `product_uid`
...
ALTER TABLE `STORE` ADD CONSTRAINT `FK_ROLE_TO_STORE_1` FOREIGN KEY (
                                                                     `role_uid`
    )
    REFERENCES `ROLE` (
                       `role_uid`
...
ALTER TABLE `SUPPLIER_STATUS` ADD CONSTRAINT `FK_SUPPLIER_TO_SUPPLIER_STATUS_1` FOREIGN KEY (
                                                                                             `supplier_uid`
    )
    REFERENCES `SUPPLIER` (
                           `supplier_uid`
...
ALTER TABLE `SUPPLIER_STATUS` ADD CONSTRAINT `FK_PRODUCT_TO_SUPPLIER_STATUS_1` FOREIGN KEY (
                                                                                            `product_uid`
    )
    REFERENCES `PRODUCT` (
                          `product_uid`
...
ALTER TABLE `STORE_STATUS` ADD CONSTRAINT `FK_STORE_TO_STORE_STATUS_1` FOREIGN KEY (
                                                                                    `store_uid`
    )
    REFERENCES `STORE` (
                        `store_uid`
...
ALTER TABLE `STORE_STATUS` ADD CONSTRAINT `FK_PRODUCT_TO_STORE_STATUS_1` FOREIGN KEY (
                                                                                      `product_uid`
    )
    REFERENCES `PRODUCT` (
                          `product_uid`
...
ALTER TABLE `ORDER_DETAIL` ADD CONSTRAINT `FK_ORDER_TABLE_TO_ORDER_DETAIL_1` FOREIGN KEY (
                                                                                          `order_uid`
    )
...
ALTER TABLE `DISTRIBUTION_LOG` ADD CONSTRAINT `FK_PRODUCT_TO_DISTRIBUTION_LOG_1` FOREIGN KEY (
                                                                                              `product_uid`
    )
    REFERENCES `PRODUCT` (
                          `product_uid`
...
ALTER TABLE `DISTRIBUTION_LOG` ADD CONSTRAINT `FK_TRANSPORT_TO_DISTRIBUTION_LOG_1` FOREIGN KEY (
                                                                                                `transport_uid`
    )
